...
#
setup_keywords['name'] = 'NE2001'
setup_keywords['description'] = 'Python port of NE2001 code'
setup_keywords['author'] = 'JXP'
setup_keywords['author_email'] = 'xavier@ucolick.org'
setup_keywords['license'] = 'BSD'
setup_keywords['url'] = 'https://github.com/pyigm/NE2001'
#
